...
bot.command('group', async ctx => {
    await ctx.replyWithMediaGroup([
        {
            type: 'photo',
            media: 'https://www.st-martin.org/assets/uploads/sites/3/2025/02/9.jpg',
            caption: '寄居蟹',
        },
        {
            type: 'photo',
            media: 'https://www.st-martin.org/assets/uploads/sites/3/2025/02/11.jpg',
            caption: 'hermitCrab',
        },
        {
            type: 'photo',
            media: 'https://questionableevolution.com/wp-content/uploads/2013/08/hermit_crab.jpg',
        },
