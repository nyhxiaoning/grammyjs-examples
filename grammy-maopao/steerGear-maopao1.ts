...
// 引入中间件
import { onlyAccept, onlyBeforeAccept } from './plugin.js'
...
;(async () => {
    await bot.api.setMyCommands([
        ...
        // { command: 'turnon', description: 'turnon' },
        // { command: 'turnoff', description: 'turnoff' },
        // { command: 'im', description: 'im' },
        // { command: 'onReceive', description: 'onReceive' },
    ])
})()
